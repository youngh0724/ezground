...
<!-- Wrapper -->
	...
	<form action="${pageContext.request.contextPath}/team/teamInsert" method="post" id="insertForm">
					<input id="teamRegion" name="teamRegion" type="hidden">
		...
		<table class="table table-striped" data-effect="fade">
			...
			<tr>
				<td>지역</td>				
				<td><select name="sido" id="sido"></select>
					<select name="gugun" id="gugun"></select></td>
					
			</tr>
			<tr>
				<td>나이대</td>
				<td><select id="teamAges">
		...
		$('#insert').click(function(){
			if($('#teamName').val() == ''){
				...
				$('#teamAges').focus();
				 ...
				 var teamRegion = $('#sido').val() +" "+ $('#gugun').val();
				 console.log(teamRegion);
				 $('#teamRegion').val(teamRegion);
				$('#insertForm').submit();
			}
		})
		</script>
